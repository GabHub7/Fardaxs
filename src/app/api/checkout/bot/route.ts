...
export async function POST(request: NextRequest) {
  ...
  // Cari user berdasarkan nomor HP yang chat ke bot. Pakai variant matching
  // (bukan exact match) karena nomor bisa tersimpan dalam format berbeda
  // dari yang dikirim bot (lihat src/lib/phone.ts untuk detail).
  ...
  const response: CheckoutResponse = {
    ...
    qr_url: payment.qr_url ? casakuQrImageUrl(payment.qr_url) : null,
