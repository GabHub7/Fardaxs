...
import { loginAction, loginWithGoogleIdToken } from '@/features/auth/actions'
...
function LoginForm() {
  ...
  return (
    ...
    >
      ...
      {bannedNotice && !serverError && (
        <div className="mb-5 rounded-[14px] border border-red-500/30 bg-red-500/10 px-4 py-3">
          <p className="text-sm text-red-400">
            Sesi Anda diakhiri karena akun ini dinonaktifkan. Hubungi CS jika ini keliru.
          </p>
        </div>
      )}
      ...
      {/* Google Login — tombol asli dirender oleh Google Identity Services
          (google-signin-button), pakai NEXT_PUBLIC_GOOGLE_CLIENT_ID kita
          sendiri. Fallback teks ditampilkan kalau script GSI gagal load. */}
      <Script
