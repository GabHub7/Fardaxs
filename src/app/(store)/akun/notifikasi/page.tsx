  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg-primary)' }}>
      <header className="sticky top-0 z-40 px-4 py-4 flex items-center gap-3"
        ...
        <h1 className="text-base font-bold" style={{ color: 'var(--text-primary)' }}>Notifikasi</h1>
      </header>
      <div className="flex flex-col items-center justify-center py-24 gap-4 px-4">
        ...
        <p className="text-sm font-semibold text-center" style={{ color: 'var(--text-primary)' }}>Notifikasi</p>
        <p className="text-xs text-center" style={{ color: 'var(--text-secondary)' }}>Semua notifikasi akan ditampilkan di sini.</p>
      </div>
    </div>
  )
}
