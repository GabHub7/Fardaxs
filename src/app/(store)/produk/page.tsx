...
export default async function ProdukPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="pb-6">
      ...
      {/* Desktop title — mobile gets it from PageHeader above, which is
          hidden on md+ now that the persistent TopNavbar lives there. */}
      <h1 className="hidden md:block text-lg font-bold px-4 pt-4" style={{ color: 'var(--text-primary)' }}>
        {serviceLabel ?? 'Produk'}
      </h1>
