...
interface PaymentOption {
  ...
  icon: LucideIcon
  iconColor: string
  category: 'qris' | 'ewallet'
  fee: string
}

const PAYMENT_OPTIONS: PaymentOption[] = [
  { id: 'QRIS', label: 'QRIS', shortLabel: 'QRIS', icon: QrCode, iconColor: '#2563EB', category: 'qris', fee: '0.7%' },
  { id: 'GOPAY', label: 'GoPay', shortLabel: 'GoPay', icon: Wallet, iconColor: '#00AA13', category: 'ewallet', fee: '2%' },
  { id: 'OVO', label: 'OVO', shortLabel: 'OVO', icon: Wallet, iconColor: '#4C3494', category: 'ewallet', fee: '2%' },
  { id: 'DANA', label: 'DANA', shortLabel: 'DANA', icon: Wallet, iconColor: '#118EEA', category: 'ewallet', fee: '1.5%' },
  { id: 'SHOPEEPAY', label: 'ShopeePay', shortLabel: 'SPay', icon: Wallet, iconColor: '#EE4D2D', category: 'ewallet', fee: '1.5%' },
]
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <opt.icon size={16} style={{ color: opt.iconColor }} className="shrink-0" />
                      <div>
                        <p
