    ...
    <div className="pb-6">
      ...
      <div className="px-4 pt-4 space-y-5">
        ...
        <section>
          ...
          <div
            className="grid grid-cols-4 gap-2.5 rounded-2xl p-3"
          ...
          <div className="grid grid-cols-5 gap-2">
            {((categories ?? []) as Category[]).map((cat) => {
              ...
              return (
                ...
                >
                  <span
                    className="relative flex items-center justify-center w-full aspect-square rounded-2xl overflow-hidden hover-lift press-effect"
                    style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', boxShadow: 'var(--shadow)' }}
                  >
                    {hasCover ? (
                      <Image
