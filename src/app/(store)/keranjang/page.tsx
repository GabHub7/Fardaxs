...
export default function KeranjangPage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: MOCK.bg }}>
      ...
      {items.length > 0 && (
        <div
          className="fixed bottom-0 left-0 right-0 px-4 pb-[calc(16px+env(safe-area-inset-bottom))] pt-4"
        ...
        >
          ...
          <Link
            ...
            className="block text-center py-3.5 rounded-[14px] text-sm font-semibold text-white"
            style={{ background: `linear-gradient(135deg, ${MOCK.primary}, #6366F1)` }}
          >
            Lanjut ke Produk
          </Link>
